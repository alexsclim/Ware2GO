...
location = Location.create(name: 'MacLeod Building', latitude: 49.26205299999999, longitude: -123.24918869999999, description: 'This is where the EECE students are at.', visited_num: 8)
...
location = Location.create(name: 'ICICS', latitude: 49.2611776, longitude: -123.24880439999998, description: 'Counter Strike majors come here', visited_num: 4)
